...
//overloaded constructor to provide a texture
OrthoMesh::OrthoMesh(ID3D11Device* device, int width, int height, WCHAR* textureFilename, int xPosition, int yPosition)
{
	// Initialize the vertex and index buffer that hold the geometry for the triangle.
	m_width = width;
	m_height = height;
