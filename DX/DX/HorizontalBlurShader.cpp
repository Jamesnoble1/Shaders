...
void HorizontalBlurShader::changeShaderBlur(bool isHighBlur)
{
	if (isHighBlur)
	{
		InitShader(L"../shaders/increasedHorizontalBlur_vs.hlsl", L"../shaders/increasedHorizontalBlur_ps.hlsl");
	}
	else
	{
		InitShader(L"../shaders/horizontalBlur_vs.hlsl", L"../shaders/horizontalBlur_ps.hlsl");
